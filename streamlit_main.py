...
data = pd.read_csv(r'https://github.com/cheezybun/asp/blob/13d6b9fd3ef1862d53a10b329dd8d6eeeaa6dedb/streamlit/airline_passenger_satisfaction.csv.csv', index_col=False)
...
def set_home():
    st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/pexels-pascal-renet-113017.jpg")
...
def set_analysis():
    ...
    with col1:
        ...
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/1.png")
    ...
    with col2:
        ...
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/2.png")
    ...
    with col1:
        ...
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/3.png")
    ...
    with col2:
        ...
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/4.png")

    col1, col2 = st.columns(2)
    with col1:
        st.markdown("#### 5: Satisfaction Level of Passengers On:")
        st.markdown('Cleanliness.')
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/5.png")
    with col2:
        st.write("#### 6: Satisfaction Level of Passengers On:")
        st.markdown('Baggage Handling.')
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/6.png")

    col1, col2 = st.columns(2)
    with col1:
        st.write("#### 7: Satisfaction Level of Passengers On:")
        st.markdown('Food and Drink.')
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/7.png")
    ...
    with col2:
        ...
        st.image("https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/8.png")
...
st.sidebar.image('https://github.com/cheezybun/asp/blob/238e7db55e69ffedda88bb7c56e304d26bdd0169/streamlit/download.jpg', width=250)
